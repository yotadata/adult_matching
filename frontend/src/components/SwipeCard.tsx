...
const SwipeCard = forwardRef<SwipeCardHandle, SwipeCardProps>(({ cardData, onSwipe, onDrag, onDragEnd }, ref) => {
  ...
  return (
    <motion.div 
      className="absolute w-full max-w-md h-[70vh] rounded-2xl bg-black/20 backdrop-blur-lg border border-white/20 shadow-2xl flex flex-col p-4 cursor-grab overflow-hidden"
      drag="x"
