...
const ActionButtons = ({ onSkip, onLike, nopeColor, likeColor }: ActionButtonsProps) => (
  <div className="flex items-center justify-between w-full">
    ...
    <button 
      onClick={onLike} 
      className="flex items-center justify-center w-40 h-14 font-bold tracking-wider text-lg text-white rounded-2xl backdrop-blur-md border border-white/20 shadow-2xl transition-all duration-200 ease-in-out hover:border-orange-400/80 hover:scale-110 active:scale-95"
