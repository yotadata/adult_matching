      ...
      <div className="flex justify-between items-center text-white max-w-md mx-auto">
        ...
        {user ? (
          ...
          <button
            ...
            className="p-4 py-2 mx-2 text-sm font-bold rounded-xl bg-white text-darkAccent hover:bg-darkAccent hover:text-white shadow-lg transition-all duration-300"
            style={{ filter: 'drop-shadow(0 0 0.5rem rgba(0, 0, 0, 0.1))' }}
          >
            ログイン
          </button>
