...
export const QUIZ_TYPES: Record<QuizTypeKey, QuizType> = {
  spnc: {
    ...
    favPlay: ['目隠しして動けない状態で焦らし続ける', '限界まで攻めて寸止めを繰り返す', '耳元で「やめてほしい？」と囁きながら続ける', '弱い部分を見つけたらそこだけ執拗に攻める'],
  ...
  spnw: {
    ...
    favPlay: ['体位を自分のタイミングで次々変えていく', '相手が声を上げるまでやめない', '「次何されるか分からない」状態を作る', '相手が力が入らなくなるまで続ける'],
  ...
  senc: {
    ...
    favPlay: ['耳元で名前を呼びながら責める', '「あなただからこうなっちゃう」と言わせるまで続ける', '普段クールな相手が声を上げる瞬間まで攻める', '泣きそうな顔をしながらも求めてくる状態にする'],
  ...
  senw: {
    ...
    favPlay: ['キスしながらゆっくり奥まで入れる', '「気持ちいい？」と聞きながら続ける', '相手が力を抜いて全部預けてくる状態にする', 'ペースを変えながら相手の反応を楽しむ'],
  ...
  spxc: {
    ...
    favPlay: ['声が漏れそうな場所で口を塞ぎながら続ける', '車の中で相手を押さえつける', 'ホテルで拘束して好き放題する', '「ここでするの？」という状況に持ち込む'],
  ...
  spxw: {
    ...
    favPlay: ['ホテルで朝から激しくする', 'シャワーを一緒に浴びながら始める', '「家ではできないこと」を全部試す', '声を気にせず出させる'],
  ...
  sexc: {
    ...
    favPlay: ['ロールプレイで日常の関係性を壊す', '「今夜だけ何でもしていい」と言わせる', '拘束して身動きできない状態で焦らす', '普段の自分では言わないような言葉を相手に言わせる'],
  ...
  sexw: {
    ...
    favPlay: ['感情が高まりすぎて乱暴になってしまう', '「好きすぎて怖い」くらい激しくなる', 'キスが止まらなくなってそのまま押し倒す', 'ロマンチックな流れから急に激しくなる'],
  ...
  mpnc: {
    ...
    favPlay: ['「もっとして」と言わせるまでやめない', '弱い部分を見つけたらそこだけ執拗に責める', '何度も達かせて動けない状態にする', '自分以外じゃ満足できない体にする'],
  ...
  mpnw: {
    ...
    favPlay: ['相手が求める前に先回りして動く', '全身くまなく触れて一番感じる場所を探す', '「もう無理」と言っても続ける', '相手が声を上げるまでやめない'],
  ...
  menc: {
    ...
    favPlay: ['顔を見ながらゆっくり奥まで入れる', '「好きだから」と言いながら激しくなる', '泣きそうな顔をされながら続ける', '相手が「もう無理」と言っても離さない'],
  ...
  menw: {
    ...
    favPlay: ['相手に押さえつけられて動けない状態になる', '「どうしてほしい？」と聞かれて答えさせられる', '抵抗できないまま全部されてしまう', '気づいたら声が出ていた'],
  ...
  mpxc: {
    ...
    favPlay: ['「こうして」と指示されながら動く', '「上手だね」と言われながら続ける', '相手の言う通りにして褒められる', '「もっとして」と言われると止まれなくなる'],
  ...
  mpxw: {
    ...
    favPlay: ['シャワーを一緒に浴びながら始まる', '朝目が覚めたら相手が先に触れてきている', '「声出してもいいよ」と言われて解放される', 'ホテルで朝から何度もされる'],
  ...
  mexc: {
    ...
    favPlay: ['「今夜は何でもしていい」と言ってしまう', '好きすぎて泣きながらされる', '感情が溢れてキスが止まらないまま始まる', '「もっと」と自分から求めてしまう'],
  ...
  mexw: {
    ...
    favPlay: ['「何でもする」と自分から言ってしまう', '好きな人に全部委ねて声が出るままにする', '「もっとして」と自分から求める', '感情が先に動いて止まれなくなる'],
