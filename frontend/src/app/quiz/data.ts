...
export const QUIZ_TYPES: Record<QuizTypeKey, QuizType> = {
  spnc: {
    ...
    favPlay: ['言葉責め', '焦らし・じらし', '目隠し', '拘束', '絶頂寸前で止める'],
  ...
  spnw: {
    ...
    favPlay: ['騎乗位以外の体位全般', '正常位・後背位でのリード', 'フェラ・手コキを指示する', '体位を頻繁に変える'],
  ...
  senc: {
    ...
    favPlay: ['耳元での囁き・言葉責め', '首筋・耳へのキス', '相手の名前を呼びながら', '視線を外させない正常位'],
  ...
  senw: {
    ...
    favPlay: ['ゆっくりした正常位', 'キスしながらのセックス', '照明を落とした雰囲気重視', '抱きしめながらの後背位'],
  ...
  spxc: {
    ...
    favPlay: ['露出・外でのプレイ', '車内セックス', 'ホテルの大きなベッドでの拘束', '人に聞かれるかもしれない状況'],
  ...
  spxw: {
    ...
    favPlay: ['ホテルでの長時間セックス', '旅先でのシャワー後すぐ', '普段しない体位を試す', '声を出させる責め'],
  ...
  sexc: {
    ...
    favPlay: ['ロールプレイ', '照明・音楽など演出を凝らした前戯', 'ホテルでの言葉責め', '「今夜だけ」な雰囲気の中での拘束'],
  ...
  sexw: {
    ...
    favPlay: ['旅先での正常位・後背位', '感情が高まってからの言葉責め', 'ロマンチックな雰囲気からの激しいセックス', '抱きしめながらの挿入'],
  ...
  mpnc: {
    ...
    favPlay: ['長時間の前戯', 'クンニ・手マン', '弱い部分への集中責め', '相手が声を上げるまでやめない'],
  ...
  mpnw: {
    ...
    favPlay: ['フェラ・手コキ', '全身マッサージからの流れ', 'クンニ・手マン', '騎乗位で相手に主導権を渡す'],
  ...
  menc: {
    ...
    favPlay: ['長時間の前戯からのゆっくりした挿入', 'キスしながらのクンニ・手マン', '正常位で顔を見ながら', '「好き」と言いながらのセックス'],
  ...
  menw: {
    ...
    favPlay: ['騎乗位で相手に全部任せる', 'フェラ・手コキをリードされながら', '抱きしめられながらの挿入', '相手のペースに全部合わせる正常位'],
  ...
  mpxc: {
    ...
    favPlay: ['指示されながらのフェラ・クンニ', 'ホテルでの長時間前戯', '言葉で誘導されながらのセックス', '相手に体位を決めてもらう'],
  ...
  mpxw: {
    ...
    favPlay: ['ホテルのシャワー後の全身への奉仕', 'お風呂・温泉での前戯', 'フェラ・クンニを時間をかけてする', '旅先での朝セックス'],
  ...
  mexc: {
    ...
    favPlay: ['旅先での長時間前戯からの挿入', 'ホテルでのフェラ・クンニ', '感情が高まってからのキスを絡めたセックス', '「好き」と言いながら尽くす'],
  ...
  mexw: {
    ...
    favPlay: ['旅先での朝・夜のセックス', 'ロマンチックな雰囲気からのクンニ・フェラ', '感情が高まってからの長時間前戯', '抱きしめながら挿入して動かない'],
