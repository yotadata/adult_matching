...
export const QUIZ_TYPES: Record<QuizTypeKey, QuizType> = {
  ...
  senc: {
    key: 'senc', name: '激情型こだわりリーダー', emoji: '❤️‍🔥',
  ...
  sexc: {
    key: 'sexc', name: '二重こだわりの情熱家', emoji: '🎭',
  ...
  sexw: {
    key: 'sexw', name: '旅先で燃えるロマンチスト', emoji: '🌌',
  ...
  mpnw: {
    key: 'mpnw', name: '気さくな万能尽くし屋', emoji: '🌸',
  ...
  menw: {
    key: 'menw', name: '縁の下の包容力型', emoji: '🕊️',
  ...
  mpxc: {
    key: 'mpxc', name: '刺激と奉仕のこだわり屋', emoji: '🍬',
  ...
  mpxw: {
    key: 'mpxw', name: '刺激好きのフレキシブル奉仕者', emoji: '✨',
  ...
  mexc: {
    key: 'mexc', name: '二重こだわりの愛情家', emoji: '💫',
  ...
  mexw: {
    key: 'mexw', name: '旅先で全部渡す一途な人', emoji: '🌕',
