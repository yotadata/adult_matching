...
export const QUIZ_TYPES: Record<QuizTypeKey, QuizType> = {
  spnc: {
    ...
    favPlay: ['目隠しして次に何をされるか分からない状態にする', '「ここが弱いね」と言いながら集中的に攻め続ける', '絶頂寸前で止めるのを繰り返す', '「やめて」と言いながら体が反応してしまう状況を作る'],
  ...
  spnw: {
    ...
    favPlay: ['初対面に近い相手と深夜に2人きりになる', '「どうしたいか」を相手に全部決めさせない状況', '体位を自分のタイミングで変えながら進める', '相手が自分に慣れていく過程を楽しむ'],
  ...
  senc: {
    ...
    favPlay: ['好きな人が珍しく弱ってるときに側にいる', '「あなただからこうなっちゃう」と言わせる状況', '耳元で名前を呼びながら進める', '普段クールな相手が崩れていく瞬間を見る'],
  ...
  senw: {
    ...
    favPlay: ['照明を落として2人だけの空気を作る', '特に計画もなく自然な流れになる', 'キスしながらゆっくり進める', '終わった後もそのまま話し続ける'],
  ...
  spxc: {
    ...
    favPlay: ['バレるかもしれない場所で2人きりになる', '車の中で急に雰囲気が変わる', '高級ホテルで非日常感の中リードする', '旅先で普段しないことを試す'],
  ...
  spxw: {
    ...
    favPlay: ['旅先のホテルで朝目が覚めたら始まる', 'シャワーを一緒に浴びた後の流れ', '見知らぬ土地で2人だけという開放感', '普段の自分と違うキャラで動ける非日常'],
  ...
  sexc: {
    ...
    favPlay: ['旅先で「今夜だけ」という空気が生まれる', '音楽・照明で演出した部屋で始まる', 'ロールプレイで日常と切り離す', '「この人とじゃないと来れなかった場所」にいる'],
  ...
  sexw: {
    ...
    favPlay: ['好きな人と初めて旅行に行った夜', '「今日は特別な日」という空気の中で始まる', '感情が高まりすぎて言葉が出なくなる状況', 'ロマンチックな流れから急に激しくなる'],
  ...
  mpnc: {
    ...
    favPlay: ['タイプの相手と2人きりで深夜まで過ごす', '「もっとして」と相手に言わせるまでやめない', '弱い部分を見つけた瞬間からそこだけ攻め続ける', '相手が自分以外じゃ満足できなくなる状況を作る'],
  ...
  mpnw: {
    ...
    favPlay: ['全身マッサージから自然な流れになる', '相手が求める前に先回りして動く', '「気持ちよかった？」と確認しながら進める', '終わった後も相手の満足を確認する'],
  ...
  menc: {
    ...
    favPlay: ['好きな人と深夜2人きりで話し込んだ後の流れ', '「あなただから」という感情が溢れた状況', '顔を見ながらゆっくり始まる', '「好き」という感情が先に来て体が動く'],
  ...
  menw: {
    ...
    favPlay: ['相手に全部委ねて流れに乗る', '「どうしてほしい？」と聞かれる状況', '抱きしめられながら始まる', '相手が主導する中で自分が崩れていく'],
  ...
  mpxc: {
    ...
    favPlay: ['ホテルで相手に「こうして」と指示される', '言葉で誘導されながら進む', '相手が全部決めてくれる状況に身を任せる', '「上手だね」と言われながらやる'],
  ...
  mpxw: {
    ...
    favPlay: ['旅先のホテルでシャワーを浴びた後の流れ', '温泉旅行で部屋に戻ってから始まる', '朝目が覚めたら相手が先に動いている', '非日常の場所で相手に尽くすことだけを考える'],
  ...
  mexc: {
    ...
    favPlay: ['好きな人と行った旅先で感情が爆発する', 'ホテルで「全部あげる」という気持ちになる', '「今夜だけは何でもする」という状況', '気持ちが溢れてキスが止まらなくなる'],
  ...
  mexw: {
    ...
    favPlay: ['好きな人と初めて旅行に行った夜に全部尽くす', 'ロマンチックな雰囲気の中で感情が先に動く', '「この人のためなら何でもできる」という状況', '旅先の朝、目が覚めたら相手のために動く'],
