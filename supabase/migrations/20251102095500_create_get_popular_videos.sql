create or replace function public.get_popular_videos(limit_count int default 20, lookback_days int default 7)
returns table (
  id uuid,
  title text,
  description text,
...
grant execute on function public.get_popular_videos(int, int) to anon, authenticated;
