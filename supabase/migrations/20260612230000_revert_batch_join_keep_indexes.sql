-- バッチJOINのクエリに問題があったため、動作確認済みのv2ロジックに戻す
-- インデックスは 20260612220000 で追加済みのため維持

-- get_videos_feed: 20260612210000 の動作確認済みロジックに戻す
...
-- get_videos_recommendations: 20260612210000 の動作確認済みロジックに戻す
